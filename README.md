...
<img src="logo.png" alt="BatMon Logo" width="120" />
...
- Системные команды для мониторинга батареи
...
- Данные сохраняются в стандартных папках ОС (см. FAQ)
...
- База данных SQLite с историей измерений:
  - **macOS/Linux**: `~/.local/share/batmon/batmon.sqlite`
  - **Windows**: `%LOCALAPPDATA%\batmon\batmon.sqlite`
